        ...
        <div class="mt-5 col-6 r">
            <form method="POST" action="{{'/members/index.blade.php'}}" style="padding:30px;">
                ...
                <div class="form-group">
                    ...
                    <input type="file" maxlength="25" class="form-control" id="image" name="image">                   
                </div>
                <div class="form-group">
                    <label for="phone_number">PHONE NUMBER :</label>
                    <input type="text" maxlength="25" class="form-control" id="phone_number" name="phone_number" >
                </div>
                <div class="form-group">
                    <label for="gmail">EMAIL :</label>
                    <input type="text" maxlength="25" class="form-control" id="gmail" name="gmail" >
                </div>
                <div class="form-group">
